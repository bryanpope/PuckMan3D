...
const Material Materials::PEACH = Material(XMFLOAT4(0.9f, 0.7f, 0.6f, 1.0f), XMFLOAT4(1.0f, 0.0f, 0.0f, 1.0f), XMFLOAT4(0.9f, 0.9f, 0.9f, 16.0f), XMFLOAT4(0.01f, 0.01f, 0.01f, 1.0f));
const Material Materials::APPLE = Material(XMFLOAT4(0.7f, 1.0f, 0.0f, 1.0f), XMFLOAT4(1.0f, 0.0f, 0.0f, 1.0f), XMFLOAT4(0.9f, 0.9f, 0.9f, 16.0f), XMFLOAT4(0.01f, 0.01f, 0.01f, 1.0f));
const Material Materials::GRAPES = Material(XMFLOAT4(0.1f, 0.0f, 1.0f, 1.0f), XMFLOAT4(1.0f, 0.0f, 0.0f, 1.0f), XMFLOAT4(0.9f, 0.9f, 0.9f, 16.0f), XMFLOAT4(0.01f, 0.01f, 0.01f, 1.0f));
const Material Materials::GHOSTFRIGHTENED = Material(XMFLOAT4(0.0f, 0.0f, 1.0f, 1.0f), XMFLOAT4(0.0f, 0.0f, 1.0f, 1.0f), XMFLOAT4(0.9f, 0.9f, 0.9f, 16.0f), XMFLOAT4(0.01f, 0.01f, 0.01f, 1.0f));
